  ...
  return function(e) {
    ...
    0: function(e, t, i) {
      ...
      const a = e => document.querySelector(e),
        c = e => "number" == typeof e ? "#" + ("00000" + e.toString(16)).slice(-6) : e,
        u = (e, t = 1) => {
          const i = c(e),
    ...
    1: function(e, t, i) {
      ...
      r.VantaBase = class {
        constructor(e = {}) {
          if (!s) return !1;
          if (r.current = this, this.windowMouseMoveWrapper = this.windowMouseMoveWrapper.bind(this), this.windowTouchWrapper = this.windowTouchWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(o.c)({}, this.defaultOptions), (e instanceof HTMLElement || "string" == typeof e) && (e = {
              el: e
            }), Object(o.c)(this.options, e), this.options.THREE && (n = this.options.THREE), this.el = this.options.el, null == this.el) h('Instance needs "el" param!');
        ...
        windowMouseMoveWrapper(e) {
          ...
          const i = t.getBoundingClientRect(),
            o = e.clientX - i.left,
            s = e.clientY - i.top;
          o >= 0 && s >= 0 && o <= i.width && s <= i.height && (this.mouseX = o, this.mouseY = s, this.options.mouseEase || this.triggerMouseMove(o, s))
        }
        ...
        setSize() {
          this.scale || (this.scale = 1), Object(o.e)() && this.options.scaleMobile ? this.scale = this.options.scaleMobile : this.options.scale && (this.scale = this.options.scale), this.width = this.el.offsetWidth || window.innerWidth, this.height = this.el.offsetHeight || window.innerHeight
        }
        resize() {
        ...
        onInit() {
          ...
          new n((function(t) {
            ...
            function w(e, i, o) {
              ...
              for (let a = 0; a < 100; a++) {
                let c = a / 100 * t.TAU,
                  u = t.createVector(e + t.cos(c) * o, i + t.sin(c) * o),
                  l = t.noise(u.x, u.y);
            ...
            function y(e, i) {
              return e = t.constrain(e, 0, t.width + 2 * r), i = t.constrain(i, 0, t.height + 2 * r), d[t.floor(i / h)][t.floor(e / h)]
            }
            ...
            t.setup = function() {
              e.initP5(t), t.smooth(), t.noStroke(),
                function() {
                  for (let e = 0; e < p; e++) {
                    let i = t.random(t.width + 2 * r),
                      o = t.random(t.height + 2 * r);
                    f.push({
                      prev: t.createVector(i, o),
                      pos: t.createVector(i, o),
                ...
                function() {
                  for (let e = 0; e < l; e++) {
                    let t = [];
                    for (let i = 0; i < u; i++) t.push(w(i * a, e * a, c));
                    d.push(t)
                  }
                }()
            }, t.draw = function() {
              t.translate(-r, -r),
                function() {
                  for (let e = 0; e < p; e++) {
                    let i = f[e],
                      o = y(i.pos.x, i.pos.y);
                    i.prev.x = i.pos.x, i.prev.y = i.pos.y, i.pos.x = g(i.pos.x + i.vel.x, t.width + 2 * r), i.pos.y = g(i.pos.y + i.vel.y, t.height + 2 * r), i.vel.add(i.acc).normalize().mult(2.2), i.acc = t.createVector(0, 0), i.acc.add(o).mult(3)
                  }
                }(),
                function() {
                  t.strokeWeight(1), t.stroke(Object(s.b)(e.options.color, .05));
                  for (let e = 0; e < f.length; e++) n.Vector.dist(f[e].prev, f[e].pos) < 10 && t.line(f[e].prev.x, f[e].prev.y, f[e].pos.x, f[e].pos.y)
                }(), m += .002
            }
          }))
        }
      }
      r.initClass(), t.default = o.a.register("TOPOLOGY", r)
    },
    3: function(e, t, i) {
      "use strict";
      i.d(t, "b", (function() {
      ...
      class r extends o.b {
        constructor(e) {
          n = e.p5 || n, super(e), this.mode = "p5"
        }
        initP5(e) {
          const t = this,
            i = e.createCanvas(t.width, t.height);
          i.parent(t.el), t.applyCanvasStyles(e.canvas, {
            background: Object(s.a)(t.options.backgroundColor)
